...
<div class="container-fluid">
                    ...
                    <?php
                      ...
                      $query= mysqli_query($conexion,"select * from productos")or die("error de sql:".mysqli_error($conexion));
                      $query2= mysqli_query($conexion,"select * from productos where cantidad < 20")or die("error de sql:".mysqli_error($conexion));
...
<div class="form-body">
      <div class="form-group row">
          <div class="col-sm-3 mb-3 mb-sm-0">
                     <a href="historial_stock.php" type="button" class="btn btn-default btn-sm"><span class="icon-file-text"></span>HISTORIAL</a>&nbsp;&nbsp;
                     <a href="abastecimiento-proveedor.php" type="button" class="btn btn-default btn-sm"><span class="icon-briefcase"></span>FILTRAR POR PROVEEDOR</a>
                     </div>
                     ...
                     <div class="muted pull-right">
                      Nº de Productos: <span class="label label-default"><?php  echo $count;  ?></span>
                     </div><br><br><br>

                     <div class="muted pull-right">
                      Nº de Productos por debajo de 20 Unidades: <span class="label label-warning"><?php  echo $count2;  ?></span>
                     </div><br>
