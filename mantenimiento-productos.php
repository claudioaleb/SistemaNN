...
JOIN stock ON productos.id_producto=stock.id_producto 
JOIN proveedores ON stock.rela_proveedor = proveedores.id_proveedor
JOIN categorias ON productos.rela_categoria = categorias.id_categoria
