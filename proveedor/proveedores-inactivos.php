...
<?php
    ...
    if (@mysqli_connect_errno()) {
        ...
        $reload = 'mantenimiento-proveedor.php';
        //consulta principal para recuperar los datos
        $query = mysqli_query($con,"SELECT * FROM proveedores where estado_proveedor='Inactivo' ORDER BY nombre_proveedor ASC LIMIT $offset,$per_page");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">MANTENIMIENTO DE PROVEEDORES INACTIVOS</h1>
                    </div>
...
-->
    ...
    <button type="button" class="btn btn-success" onclick="location.href='mantenimiento-proveedor.php'"><span class="icon-list1"></span> Proveedores Activos</button>
</div>
        <div class="panel-body mb-4" align="left">

            <div class="input-group">

                <button type="button" class="btn btn-success" onclick="location.href='formulario-alta-proveedor.php'"><span class="icon-user-add"></span> Añadir Proveedor</button>
    ...
    <div class="table-responsive-sm">
        <table class="table table-sm table-striped table-bordered table-hover table-condensed">
          ...
          <tbody>
            ...
            $sql = $conexion->query("SELECT * FROM proveedores where estado_proveedor='Inactivo' ORDER BY nombre_proveedor, razon_social ASC");
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo $row['direccion_proveedor'].', '.$row['barrio_proveedor'];?></td>
                    <td><?php echo $row['email_proveedor'];?></td>
                    <td><?php echo $row['telefono_fijo_proveedor'];?></td>
                    <td><?php echo $row['telefono_celular_proveedor'];?></td>
                    <td><?php if ($row['estado_proveedor'] == 'Activo'){ 
                        echo '<span class="label label-success">Activo</span>'; } 
                        else if ($row['estado_proveedor'] == 'Inactivo' ) { 
                        echo '<span class="label label-danger">Inactivo</span>';} ?></td>
                    <td><?php echo $row['fecha_alta_proveedor'];?></td>

                    <td align="center"> 
                        <button class="btn btn-success btn-sm agregar"
                            id_cliente="<?php echo $row['id_proveedor'];?>"
                            type="button" data-toggle="modal" data-target="#agregarProveedor"><i class='icon-add-outline'></i></button>
                    </td>
                    <td align="center"> 
                        <button class="btn btn-danger btn-sm borrar"
                            id_cliente="<?php echo $row['id_proveedor'];?>"
                            type="button" data-toggle="modal" data-target="#eliminarProveedor"><i class='icon-trash'></i></button>
                    </td>

                    <?php include_once 'modal-alta-proveedor.php';?>
                    <?php include_once '../acciones/eliminar-proveedor.php';?>
    ...
    <script src="buscar_proveedores.js"></script>
     <script src="../estilos/sweetalert2/sweetalert2.js"></script>
     <script type="text/javascript">
$(document).on('click', '.borrar', function() {

    $('#agregarProveedor').showModal(); 

});
<script type="text/javascript">
$(document).on('click', '.borrar', function() {

    $('#eliminarProveedor').showModal(); 
