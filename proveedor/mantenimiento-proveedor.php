...
<?php
    ...
    if (@mysqli_connect_errno()) {
        ...
        $query = mysqli_query($con,"SELECT * FROM proveedores where estado_proveedor='Activo' ORDER BY nombre_proveedor ASC LIMIT $offset,$per_page");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">MANTENIMIENTO DE PROVEEDORES ACTIVOS</h1>
                    </div>
...
-->
    ...
    <button type="button" class="btn btn-success" onclick="location.href='proveedores-inactivos.php'"><span class="icon-list1"></span> Proveedores Inactivos</button>
</div>
    ...
    <div class="table-responsive-sm">
        <table class="table table-sm table-striped table-bordered table-hover table-condensed">
          ...
          <tbody>
            ...
            $sql = $conexion->query("SELECT * FROM proveedores where estado_proveedor='Activo' ORDER BY nombre_proveedor, razon_social ASC");
            ...
            ?>
                <tr>
                    ...
                    <td align="center">
                        <a href="formulario-modificar-proveedor.php?id_proveedor=<?php echo $row['id_proveedor'];?>" type="button" class="btn btn-warning btn-sm" aria-hidden="true"><i class='icon-pencil'></i></a>
                    </td>
                    <td align="center"> 
                        <button class="btn btn-danger btn-sm borrar"
                            id_proveedor="<?php echo $row['id_proveedor'];?>"
                            type="button" data-toggle="modal" id="eliminar" data-target="#eliminarProveedor"><i class='icon-trash'></i></button>
                    </td>

                    <?php include_once 'modal-baja-proveedor.php';?>
                </tr>
            <?php
            }
            }else{
...
$(document).on('click', '.borrar', function() {
    ...
    <script>
            $('#eliminarProveedor').on('show.bs.modal', function(e) {
