...
$registros = mysqli_query ($conexion, "select * from proveedores where id_proveedor = $_REQUEST[id_proveedor];") or 
die ("Error de SQL");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h5>MODIFICACION DE DATOS DEL PROVEEDOR</h5>
                    </div>
...
<div class="col-md-12"> <!-- Tamaño de la columna -->
        ...
        <div class="card card-info">
            ...
            <div class="card-body">
               <?php require_once '../acciones/update-proveedores.php';?>
				<!-- Formulario-->
			<form action="" method="POST" >
                ...
                <div class="form-body">
					...
					<div class="form-group row">
			        	...
			        	<label>Nombre:</label>   
						      <input type="text" class="form-control" name="nombre_proveedor" value="<?php echo $reg['nombre_proveedor']; ?>" placeholder="Nombre del Proveedor" autocomplete="off" readonly>
						    </div>

                        <div class="col-sm-3 mb-3 mb-sm-0">
						<label>Razon Social:</label>
						      <input type="text" class="form-control" name="razon_social" value="<?php echo $reg['razon_social']; ?>" placeholder="Razon Social" autocomplete="off" readonly>
						    </div>

						    <div class="col-sm-3 mb-3 mb-sm-0">
						    	<label>Direccion</label>
						      <input type="text" class="form-control" name="direccion_proveedor" value="<?php echo $reg['direccion_proveedor']; ?>" placeholder="Direccion del Proveedor" autocomplete="off">
						    </div>
                        <div class="col-sm-3 mb-3 mb-sm-0">
                                <label>Barrio</label>
                              <input type="text" class="form-control" name="barrio_proveedor" value="<?php echo $reg['barrio_proveedor']; ?>" placeholder="Barrio del Proveedor" autocomplete="off">
                            </div>

                        <div class="col-sm-3 mb-3 mb-sm-0">
						<label>Email:</label>
						      <input type="text" class="form-control" name="email_proveedor" value="<?php echo $reg['email_proveedor']; ?>" autocomplete="off">
						    </div>
	        		
	        			<div class="col-sm-3 mb-3 mb-sm-0">
			        	<label>Telefono Fijo</label>
						      <input type="text" class="form-control" id="telefono_fijo_proveedor" name="telefono_fijo_proveedor" value="<?php echo $reg['telefono_fijo_proveedor']; ?>" placeholder="Telefono Fijo" autocomplete="off">
						    </div>

						
						    <div class="col-sm-3 mb-3 mb-sm-0">
						    	<label>Telefono Celular</label>
						      <input type="text" class="form-control" id="telefono_celular_proveedor" name="telefono_celular_proveedor" value="<?php echo $reg['telefono_celular_proveedor']; ?>" placeholder="Barrio del Cliente" autocomplete="off">
						    </div>

                        <!--<div class="col-sm-3 mb-3 mb-sm-0">
                        <label>Estado:</label>
                            
                              <select readonly class="form-control" id="estado_proveedor" name="estado_proveedor" value="<?php echo $reg['estado_proveedor']; ?>" >
                                <option value="Activo" 

                                <?php
                                if($reg['estado_proveedor'] == 'Activo')
                                  echo 'selected';
                                ?>
                                ...
                                <?php
                                if($reg['estado_proveedor'] == 'Inactivo')
                                  echo 'selected';
                                ?>
				...
				<div class="form-footer">
                    ...
                    <input type="hidden" id="id_proveedor" name="id_proveedor" value="<?php  echo $reg['id_proveedor']; ?>">
