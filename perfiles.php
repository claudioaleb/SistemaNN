...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">ROLES DE EMPLEADOS</h1>
                    </div>
 ...
 <div class="col-md-12"> <!-- Tamaño de la columna -->
        ...
        <div class="card card-info">
          ...
          <?php require_once 'acciones/alta-empleado.php';?>
                ...
                <div class="form-body">
                    ...
                    <div class="form-group row">
                            <div class="col-sm-3 mb-3 mb-sm-0">
                                 <label>CÓDIGO:</label>
                              <input type="text" class="form-control" name="id_empleado" value="<?php echo time(); ?>" readonly>
                            </div>
 
                            <div class="col-sm-3">
                                <label>Fecha de Alta:</label>
                              <input type="text" id="fecha_alta_empleado" name="fecha_alta_empleado" class="form-control" value="<?php echo date('d-m-Y'); ?>" readonly>
                            </div>

                            <div class="col-sm-3 mb-3 mb-sm-0">
                                <label>Nombre:</label>
                              <input type="text" class="form-control" id="nombre_empleado" name="nombre_empleado" placeholder="Nombre del Empleado" autocomplete="off">
                            </div>

                        
                            <div class="col-sm-3">
                                <label>Apellido:</label>
                              <input type="text" class="form-control" id="apellido_empleado" name="apellido_empleado" placeholder="Apellido del Empleado" autocomplete="off">
                            </div>
                    </div>
                    ...
                    <div class="form-group row">
                            <div class="col-sm-3 mb-3 mb-sm-0">
                                <label>D.N.I:</label>
                              <input type="text" class="form-control" id="dni_empleado" name="dni_empleado" placeholder="D.N.I del Empleado" autocomplete="off">
                            </div>

                            <div class="col-sm-3 mb-3 mb-sm-0">
                                <label>Nacimiento:</label>
                              <input type="date" class="form-control" id="nacimiento_empleado" name="nacimiento_empleado" autocomplete="off">
                            </div>
                  
                            <div class="col-sm-3 mb-3 mb-sm-0">
                                <label>Dirección: </label>
                              <input type="text" class="form-control" id="direccion_empleado" name="direccion_empleado" placeholder="Dirección del Empleado" autocomplete="off">
                            </div>

                       
                            <div class="col-sm-3 mb-3 mb-sm-0">
                                 <label>Barrio: </label>
                              <input type="text" class="form-control" id="barrio_empleado" name="barrio_empleado" placeholder="Barrio del Empleado" autocomplete="off">
                            </div>
                            ...
                            <div class="col-sm-3 mb-3 mb-sm-0">
                                <label>Cargo:</label>
                              <input type="text" class="form-control" id="cargo_empleado" name="cargo_empleado" placeholder="Cargo del Empleado" autocomplete="off">
                            </div>
                    </div><br>

                    <div class="panel panel-default">
                         <div class="panel-heading"> CONTACTO DEL EMPLEADO</div>
                    </div><br>
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-3 mb-3 mb-sm-0">
                                 <label>Email: </label>
                              <input type="text" class="form-control" id="email_empleado" name="email_empleado" placeholder="Email del Empleado" autocomplete="off">
                            </div>

                        
                            <div class="col-sm-3 mb-3 mb-sm-0">
                                <label>Telefono: </label>
                              <input type="text" class="form-control" id="telefono_empleado" name="telefono_empleado" placeholder="Telefono del Empleado" autocomplete="off">
                            </div>
                    </div>
