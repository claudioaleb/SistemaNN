...
$registros = mysqli_query ($conexion, "select * from clientes JOIN persona ON clientes.rela_persona = id_persona where id_cliente = $_REQUEST[id_cliente];");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h5>MODIFICACION DE DATOS DEL CLIENTE</h5>
                    </div>
...
<div class="col-md-12"> <!-- Tamaño de la columna -->
        ...
        <div class="card card-info">
            ...
            <div class="card-body">
             ...
             <?php require_once '../acciones/update-cliente.php';?>
				<!-- Formulario-->
			<form action="" method="POST" >
                ...
                <div class="form-body">
					...
					<div class="form-group row">
			        	...
			        	<label>Nombre:</label>   
						      <input type="text" class="form-control" value="<?php echo $reg['nombre_persona']; ?>" placeholder="Nombre del Cliente" autocomplete="off" readonly>
						    </div>

                        <div class="col-sm-3 mb-3 mb-sm-0">
						<label>Apellido:</label>
						      <input type="text" class="form-control" value="<?php echo $reg['apellido_persona']; ?>" placeholder="Apellido del Cliente" autocomplete="off" readonly>
						    </div>

						    <div class="col-sm-3 mb-3 mb-sm-0">
						    	<label>D.N.I:</label>
						      <input type="text" class="form-control" value="<?php echo $reg['dni_persona']; ?>" placeholder="D.N.I del Cliente" autocomplete="off" readonly>
						    </div>

                        <div class="col-sm-3 mb-3 mb-sm-0">
						<label>Nacimiento:</label>
						      <input type="date" class="form-control" value="<?php echo $reg['fecha_nacimiento']; ?>" autocomplete="off" readonly>
						    </div>
	        		</div>
	        		...
	        		<div class="form-group">
			        	...
			        	<label>Estado:</label>
						      ...
						      <select class="form-control" id="estado_cliente" name="estado_cliente" value="<?php echo $reg['estado_cliente']; ?>">
						      	<option value="Activo"

						      	<?php
						      	if($reg['estado_cliente'] == 'Activo')
						      	  echo 'selected';
						      	?>
						      	...
						      	<?php
						      	if($reg['estado_cliente'] == 'Inactivo')
						      	  echo 'selected';
						      	?>
				...
				<div class="form-footer">
                    ...
                    <input type="hidden" id="id_cliente" name="id_cliente" value="<?php  echo $reg['id_cliente']; ?>">
