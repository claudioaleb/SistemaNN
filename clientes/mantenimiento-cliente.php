...
<?php
    ...
    if (@mysqli_connect_errno()) {
        ...
        $reload = 'mantenimiento-clientes.php';
        //consulta principal para recuperar los datos
        $query = mysqli_query($con,"SELECT * FROM clientes JOIN persona ON clientes.rela_persona = id_persona  WHERE estado_cliente = 'Activo'  ORDER BY apellido_persona, nombre_persona  ASC LIMIT $offset,$per_page");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">MANTENIMIENTO DE CLIENTES</h1>
                    </div>
...
-->
    ...
    <button type="button" class="btn btn-success" onclick="location.href='clientes-inactivos.php'"><span class="icon-list1"></span> Clientes Inactivos</button>
...
ORDER BY apellido_persona, nombre_persona ASC");
            ...
            ?>
                <tr>
                    ...
                    <td align="center">
                        <a href="formulario-modificar-cliente.php?id_cliente=<?php echo $row['id_cliente'];?>" type="button" class="btn btn-warning btn-sm" aria-hidden="true"><i class='icon-pencil'></i></a>
                    </td>
                    <td align="center"> 
                    ...
                    <?php include_once 'modal-baja-cliente.php';?>
