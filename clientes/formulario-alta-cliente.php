            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h5>FORMULARIO DE REGISTRO DE CLIENTE</h5>
                    </div>
...
<!---------------------------------------------------------- >
    ...
    <div class="col-md-12"> <!-- Tamaño de la columna -->
        ...
        <?php require_once '../acciones/alta-clientes.php';?>
                ...
                <div class="form-body">
                   ...
                   <div class="form-group row">
                        <div class="col-sm-3 mb-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control text-center" name="id_cliente" value="<?php echo time(); ?>" readonly>
                        </div>

                        <div class="col-sm-3 mb-3 mb-sm-0">
                            <label>Fecha de Alta</label>
                            <input type="text" name="fecha_alta" class="form-control text-center" value="<?php echo date('d-m-Y'); ?>" readonly>
                        </div>
                    </div>
    ...
    <label>PERSONA</label>
       <div class="input-group">
           ...
           <select name="rela_persona" class="form-control">
         ...
         <div class="col-sm-3">
                            <label>Estado</label>
                            <select class="form-control text-center" name="estado_cliente">
                    ...
                    <button type="button" class="btn btn-secondary btn-sm" onclick="location.href='mantenimiento-cliente.php'"><span class="icon-reply1"></span> Volver</button>                     
