    ...
    <div class="col-md-12"> <!-- Tamaño de la columna -->
        ...
        <div class="card card-info">
            ...
            <div class="card-body">
                ...
                <?php require_once '../acciones/alta-categoria.php';?>
                ...
                <div class="form-body">
                    ...
                    <div class="form-group row">          
                            <div class="col-sm-3 mb-3 mb-sm-0">
                                <label>CÓDIGO:</label>
                              <input type="text" class="form-control" name="id_categoria" value="<?php echo time(); ?>" readonly>
                            </div>
        
                            <div class="col-sm-3 mb-3 mb-sm-0">
                                <label>Nombre:</label>
                              <input type="text" class="form-control" id="nombre_categoria" name="nombre_categoria" placeholder="Nombre de la Categoría" autocomplete="off">
                            </div>
                    </div>
                    ...
                    <button type="button" class="btn btn-secondary btn-sm" onclick="location.href='mantenimiento-categorias.php'"><span class="icon-reply1"></span> Volver</button>   
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary btn-sm" href="">SALIR</a>
                </div>
            </div>
        </div>
    </div>
